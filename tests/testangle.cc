...
TEST_CASE("angle-add", "[angle]")
{
  ...
  REQUIRE(a.InDegrees() == Approx(180.0f));
  REQUIRE(
      (euco::Angle::FromDegrees(90) + euco::Angle::FromRadians(euco::Pi() / 2.0f)).InDegrees() ==
      Approx(180.0f));
}
...
TEST_CASE("angle-sub", "[angle]")
{
  ...
  REQUIRE(a.InDegrees() == Approx(90.0f));
  REQUIRE(
      (euco::Angle::FromDegrees(180) - euco::Angle::FromRadians(euco::Pi() / 2.0f)).InDegrees() ==
      Approx(90.0f));
}
...
TEST_CASE("angle-multi", "[angle]")
{
  ...
  a *= 2.0f;
  REQUIRE(a.InDegrees() == Approx(180.0f));
  REQUIRE((euco::Angle::FromDegrees(90) * 2.0f).InDegrees() == Approx(180.0f));
  REQUIRE((2.0f * euco::Angle::FromDegrees(90)).InDegrees() == Approx(180.0f));
}
...
TEST_CASE("angle-div", "[angle]")
{
  ...
  a /= 2;
  REQUIRE(a.InDegrees() == Approx(90.0f));
  REQUIRE((euco::Angle::FromDegrees(180) / 2.0f).InDegrees() == Approx(90.0f));
}
...
TEST_CASE("angle-tan", "[angle]")
{
  ...
  REQUIRE(euco::Tan(euco::Angle::FromDegrees(60.0f)) == Approx(euco::Sqrt(3.0f)));
}
