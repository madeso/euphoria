...
{
  class DukUpdateSystem : public core::ComponentSystem, public core::ComponentSystemUpdate
  {
  ...
  class DukInitSystem : public core::ComponentSystem, public core::ComponentSystemInit
  {
    core::EntReg*                  reg;
  ...
  public:
    ...
    DukSystems(core::Systems* s, duk::Duk* d)
        : systems(s)
        , duk(d)
    {
    }
    ...
    Integrate(duk::Duk* duk)
    {
      ...
      duk->BindObject(
          ...
          BindObject()
              ...
              .AddFunction(
                  "OnInit",
                  MakeBind<std::string, std::vector<core::ComponentId>, FunctionReference>(
                      [&](Context*                        ctx,
                          const std::string&              name,
                          const std::vector<core::ComponentId>& types,
      ...
      duk->BindObject(
          ...
          BindObject().AddFunction(
              "NewRandom", MakeBind<>([&](Context* ctx) -> int {
                return ctx->ReturnObject(std::make_shared<core::Random>());
              })));
          ...
          BindObject()
              .AddFunction(
                  ...
                  MakeBind<std::vector<core::ComponentId>>(
                      [&](Context*                        ctx,
                          const std::vector<core::ComponentId>& types) -> int {
              ...
              .AddFunction(
                  "DestroyEntity",
                  MakeBind<core::EntityId>([&](Context* ctx, core::EntityId entity) -> int {
              ...
              .AddFunction(
                  ...
                  MakeBind<core::EntityId, core::ComponentId>(
                      [&](Context* ctx, core::EntityId ent, core::ComponentId comp) -> int {
                        return ctx->Return(registry.GetProperty(ent, comp));
                      }))
              .AddFunction(
                  "Set",
                  MakeBind<core::EntityId, core::ComponentId, ObjectReference>(
                      [&](Context*    ctx,
                          core::EntityId    ent,
              ...
              .AddFunction(
                  ...
                  MakeBind<core::ComponentId>(
                      [&](Context* ctx, core::ComponentId ent) -> int {
          ...
          BindClass<CPosition2>()
              .AddMethod(
                  ...
                  MakeBind<CPosition2>([](Context* ctx, CPosition2& p) -> int {
                    return ctx->ReturnObject(std::make_shared<core::vec2f>(p.pos));
                  }))
              .AddMethod(
                  "SetPos",
                  MakeBind<CPosition2, core::vec2f>(
                      [](Context* ctx, CPosition2& p, const core::vec2f& pos) -> int {
                        p.pos = pos;
                        return ctx->ReturnVoid();
                      }))
              .AddMethod(
          ...
          BindClass<CSprite>().AddMethod(
              ...
              MakeBind<CSprite, CPosition2>(
                  [](Context* ctx, const CSprite& sp, const CPosition2& p)
                      -> int {
                    return ctx->ReturnObject(std::make_shared<core::Rectf>(
          ...
          BindClass<core::Rectf>()
              .AddMethod(
                  ...
                  MakeBind<core::Rectf, core::Rectf>(
                      [](Context* ctx, const core::Rectf& lhs, const core::Rectf& rhs)
                          -> int {
                        return ctx->ReturnBool(lhs.ContainsExclusive(rhs));
                      }))
              .AddMethod(
                  "GetHeight",
                  MakeBind<core::Rectf>([](Context* ctx, const core::Rectf& r) -> int {
      ...
      duk->BindClass(
          ...
          BindClass<core::Random>()
              .AddMethod(
                  "NextFloat01",
                  MakeBind<core::Random>([](Context* ctx, core::Random& rnd) -> int {
                    return ctx->ReturnNumber(rnd.NextFloat01());
                  }))
              .AddMethod(
                  "NextRangeFloat",
                  MakeBind<core::Random, float>(
                      [](Context* ctx, core::Random& rnd, float f) -> int {
              ...
              .AddMethod(
                  ...
                  MakeBind<core::Random, core::Rectf>(
                      [](Context* ctx, core::Random& rnd, const core::Rectf& r) -> int {
                        return ctx->ReturnObject(
                            std::make_shared<core::vec2f>(r.RandomPoint(&rnd)));
                      }))
