...
namespace euphoria::engine
{
  ...
  bool
  DukRegistry::GetCustomComponentByName(const std::string& name, core::ComponentId* id)
  {
  ...
  void
  DukRegistry::SetProperty(core::EntityId ent, core::ComponentId comp, duk::ObjectReference value)
  {
