...
>
void PrintHierarchy(T item, LabelFunction label, FindChildrenFunction findChildren, PrintFunction print, const TreeStyle& style = DetermineStyle(), const std::string& a_indent = "", int index = 0, bool last = true)
{
    ...
    {
        PrintHierarchy<T, LabelFunction, FindChildrenFunction, PrintFunction>(*it, label, findChildren, print, style, indent, index + 1, it + 1 == kids.end());
    }
}
