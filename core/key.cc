...
namespace
{
  ...
  AllKeys()
  {
    static Keyname<Key> names = Keyname<Key>(Key::UNBOUND, Key::INVALID)(
        ...
        Key::Z, "Z")(Key::CAPSLOCK, "Capslock")(Key::F1, "F1")(Key::F2, "F2")(
        Key::F3, "F3")(Key::F4, "F4")(Key::F5, "F5")(Key::F6, "F6")(
        Key::F7, "F7")(Key::F8, "F8")(Key::F9, "F9")(Key::F10, "F10")(
        Key::F11, "F11")(Key::F12, "F12")(Key::PRINTSCREEN, "Printscreen")(
        ...
        Key::KEYPAD_DIVIDE, "Kp_Divide")(Key::KEYPAD_MULTIPLY, "Kp_Multiply")(
        Key::KEYPAD_MINUS, "Kp_Minus")(Key::KEYPAD_PLUS, "Kp_Plus")(
        Key::KEYPAD_ENTER, "Kp_Enter")(Key::KEYPAD_1, "Kp_1")(
        Key::KEYPAD_2, "Kp_2")(Key::KEYPAD_3, "Kp_3")(Key::KEYPAD_4, "Kp_4")(
        Key::KEYPAD_5, "Kp_5")(Key::KEYPAD_6, "Kp_6")(Key::KEYPAD_7, "Kp_7")(
        Key::KEYPAD_8, "Kp_8")(Key::KEYPAD_9, "Kp_9")(Key::KEYPAD_0, "Kp_0")(
        Key::KEYPAD_PERIOD, "Kp_Period")(Key::APPLICATION, "Application")(
        Key::POWER, "Power")(Key::KEYPAD_EQUALS, "Kp_Equals")(Key::F13, "F13")(
        ...
        Key::VOLUME_UP, "Volumeup")(Key::VOLUME_DOWN, "Volumedown")(
        Key::KEYPAD_COMMA, "Kp_Comma")(
        Key::KEYPAD_EQUALS_AS_400, "Kp_Equalsas400")(
        Key::ALT_ERASE, "Alterase")(Key::SYSREQ, "Sysreq")(
        Key::CANCEL, "Cancel")(Key::CLEAR, "Clear")(Key::PRIOR, "Prior")(
        Key::SECOND_RETURN, "Return2")(Key::SEPARATOR, "Separator")(
        Key::OUT, "Out")(Key::OPER, "Oper")(Key::CLEAR_AGAIN, "Clearagain")(
        Key::CRSEL, "Crsel")(Key::EXSEL, "Exsel")(Key::KEYPAD_00, "Kp_00")(
        ...
        Key::KEYPAD_PERCENT, "Kp_Percent")(Key::KEYPAD_LESS, "Kp_Less")(
        ...
        Key::SHIFT_LEFT, "Lshift")(Key::ALT_LEFT, "Lalt")(
        Key::GUI_LEFT, "Lgui")(Key::CTRL_RIGHT, "Rctrl")(
        Key::SHIFT_RIGHT, "Rshift")(Key::ALT_RIGHT, "Ralt")(
        Key::GUI_RIGHT, "Rgui")(Key::MODE, "Mode")(
