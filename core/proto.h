...
bool
LoadProtoText(google::protobuf::Message* t, const std::string& path);
bool
SaveProtoText(const google::protobuf::Message& t, const std::string& path);
...
std::string
LoadProtoJson(FileSystem* fs, google::protobuf::Message* t,
