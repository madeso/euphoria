...
{
    const auto a = eu::Angle::from_degrees(180);
...
{
    const auto a = eu::Angle::from_radians(eu::pi);
    REQUIRE(a.as_degrees() == APPROX(180.0f));
}

TEST_CASE("angle-constructor_percent", "[angle]")
{
    const auto a = eu::Angle::from_percent_of_360(0.5f);
    REQUIRE(a.as_degrees() == APPROX(180.0f));
}

TEST_CASE("angle-wrapped", "[angle]")
{
    const auto a = eu::Angle::from_degrees(360 + 90).get_wrapped();
    REQUIRE(a.as_degrees() == APPROX(90.0f));
}

TEST_CASE("angle-wrap", "[angle]")
{
    auto a = eu::Angle::from_degrees(360 + 90);
...
{
    auto a = eu::Angle::from_degrees(90);
    a += eu::Angle::from_radians(eu::pi / 2.0f);
    REQUIRE(a.as_degrees() == APPROX(180.0f));
    REQUIRE((eu::Angle::from_degrees(90)
             + eu::Angle::from_radians(eu::pi / 2.0f))
                    .as_degrees()
            == APPROX(180.0f));
}
...
{
    auto a = eu::Angle::from_degrees(180);
    a -= eu::Angle::from_radians(eu::pi / 2.0f);
    REQUIRE(a.as_degrees() == APPROX(90.0f));
    REQUIRE((eu::Angle::from_degrees(180)
             - eu::Angle::from_radians(eu::pi / 2.0f))
                    .as_degrees()
            == APPROX(90.0f));
}
...
TEST_CASE("angle-multi", "[angle]")
{
    ...
    a *= 2.0f;
    REQUIRE(a.as_degrees() == APPROX(180.0f));
    REQUIRE((eu::Angle::from_degrees(90) * 2.0f).as_degrees()
            == APPROX(180.0f));
    REQUIRE((2.0f * eu::Angle::from_degrees(90)).as_degrees()
            == APPROX(180.0f));
}
...
TEST_CASE("angle-div", "[angle]")
{
    ...
    a /= 2;
    REQUIRE(a.as_degrees() == APPROX(90.0f));
    REQUIRE((eu::Angle::from_degrees(180) / 2.0f).as_degrees()
            == APPROX(90.0f));
}
...
{
    REQUIRE(eu::tan(eu::Angle::from_degrees(0.0f)) == APPROX(0.0f));
    REQUIRE(eu::tan(eu::Angle::from_degrees(45.0f)) == APPROX(1.0f));
    REQUIRE(eu::tan(eu::Angle::from_degrees(180.0f)) == APPROX(0.0f));
    REQUIRE(eu::tan(eu::Angle::from_degrees(225.0f)) == APPROX(1.0f));
    REQUIRE(eu::tan(eu::Angle::from_degrees(60.0f))
            == APPROX(eu::sqrt(3.0f)));
}
...
TEST_CASE("angle-Wikipedia constants", "[angle]")
{
    ...
    SECTION("sin")
    {
        REQUIRE(eu::sin(eu::Angle::from_degrees(0.0f)) == APPROX(0.0f));
        REQUIRE(eu::sin(eu::Angle::from_degrees(90.0f)) == APPROX(1.0f));
        REQUIRE(eu::sin(eu::Angle::from_degrees(180.0f)) == APPROX(0.0f));
        REQUIRE(eu::sin(eu::Angle::from_degrees(30.0f)) == APPROX(0.5f));
        REQUIRE(eu::sin(eu::Angle::from_degrees(15.0f)) == APPROX(a));
        REQUIRE(eu::sin(eu::Angle::from_degrees(75.0f)) == APPROX(b));
    }

    SECTION("cos")
    {
        REQUIRE(eu::cos(eu::Angle::from_degrees(0.0f)) == APPROX(1.0f));
        REQUIRE(eu::cos(eu::Angle::from_degrees(90.0f)) == APPROX(0.0f));
        REQUIRE(eu::cos(eu::Angle::from_degrees(180.0f)) == APPROX(-1.0f));
        REQUIRE(eu::cos(eu::Angle::from_degrees(60.0f)) == APPROX(0.5f));
        REQUIRE(eu::cos(eu::Angle::from_degrees(15.0f)) == APPROX(b));
        REQUIRE(eu::cos(eu::Angle::from_degrees(75.0f)) == APPROX(a));
    }
