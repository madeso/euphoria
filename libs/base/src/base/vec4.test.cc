...
{
    const auto v = core::vec4f(1.0f, 2.0f, 3.0f, 4.0f);
...
{
    const auto v = core::vec4f(core::vec3f(1.0f, 2.0f, 3.0f), 1.0f);
    REQUIRE(v.x == approx(1.0f));
    REQUIRE(v.y == approx(2.0f));
    REQUIRE(v.z == approx(3.0f));
...
{
    const auto v = core::vec4f(1.0f, 2.0f, 3.0f, 0.0f).to_vec3();
    REQUIRE(v.x == approx(1.0f));
    REQUIRE(v.y == approx(2.0f));
    REQUIRE(v.z == approx(3.0f));
}
