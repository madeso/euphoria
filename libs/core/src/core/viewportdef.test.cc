...
{
    const auto vp = euco::ViewportDefinition::from_screen_pixel(100, 100);
...
{
    const auto vp = euco::ViewportDefinition::from_extend(10, 5, 100, 100);
...
{
    const auto vp = euco::ViewportDefinition::from_fit_with_black_bars(10, 5, 100, 100);
    REQUIRE(vp.virtual_width == Approx(10));
