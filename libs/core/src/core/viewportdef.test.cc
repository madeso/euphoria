...
{
    const auto vp = euco::ViewportDefinition::screen_pixel(100, 100);
...
{
    const auto vp = euco::ViewportDefinition::extend(10, 5, 100, 100);
...
{
    const auto vp = euco::ViewportDefinition::fit_with_black_bars(10, 5, 100, 100);
    REQUIRE(vp.virtual_width == Approx(10));
