...
{
    REQUIRE(euco::RemapTo(
                    euco::MakeRange<float>(0, 3),
                    euco::MakeRange<float>(0, 2),
                    1.5f)
            == Approx(1.0f));
}
