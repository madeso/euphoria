...
TEST_CASE("commandline", "[commandline]")
{
    ...
    SECTION("escapes")
    {
        ...
        CHECK(vec == euco::parse_commandline("dog \\n \\t"));
    }
    ...
    SECTION("escapes with space")
    {
        ...
        CHECK(vec == euco::parse_commandline("dog cat \"cat and dog\""));
    }
    ...
    SECTION("escapes without quotes")
    {
        ...
        CHECK(vec == euco::parse_commandline("dog \\\"cat\\\""));
    }
    ...
    SECTION("single quote strings")
    {
        ...
        CHECK(vec == euco::parse_commandline("dog 'cat and dog'"));
    }
