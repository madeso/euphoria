...
TEST_CASE("quat-testLocalAxis", "[quat]")
{
    ...
    q = euco::quatf::from_axis_angle(euco::axis_angle::right_hand_around(
...
{
    EXPECT_PRED_FORMAT2(
            euco::quatf::from_axis_angle(euco::axis_angle::right_hand_around(
                    euco::unit3f::up(), euco::angle::from_degrees(-90))),
            euco::quatf::look_at(
                    euco::vec3f(0, 0, 0),
                    euco::vec3f(5, 0, 0),
...
{
    const auto a = euco::quatf::from_axis_angle(euco::axis_angle::right_hand_around(
            euco::unit3f::up(), euco::angle::from_degrees(90)));
    const auto b
            = euco::quatf::from_axis_angle(euco::axis_angle::right_hand_around(
                                                 euco::unit3f::up(),
