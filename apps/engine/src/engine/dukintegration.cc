...
namespace euphoria::engine
{
    ...
    struct DukSystems
    {
        ...
        DukSystems(core::ecs::Systems* s, duk::Duk* d)
            : systems(s)
            , duk(d)
        {
        }
        ...
        AddUpdate(const std::string& name, duk::FunctionReference func)
        {
            ...
            (
                std::make_shared<DukUpdateSystem>
                (
                    name,
                    func,
                    duk
        ...
        Integrate(duk::Duk* duk)
        {
            ...
            (
                ...
                (
                    ...
                    (
                        [&](Context* ctx, core::ecs::EntityId entity) -> int
                        {
                ...
                (
                    ...
                    (
                        ...
                        (
                            Context* ctx,
                            const std::string& name,
                            Optional<FunctionReference> setup
                        ) -> int
                        {
                            if(setup)
                            {
            ...
            (
                ...
                (
                    ...
                    (
                        ...
                        (
                            ...
                            const core::Rectf& rhs
                        ) -> int
                        {
                            return ctx->ReturnBool
                            (
                                lhs.ContainsExclusive(rhs)
                            );
                        }
                    )
                )
                ...
                (
                    ...
                    MakeBind<core::Rectf>
                    (
                        [](Context* ctx, const core::Rectf& r) -> int
                        {
            ...
            (
                ...
                (
                    ...
                    (
                        [](Context* ctx, core::Random& rnd) -> int
                        {
